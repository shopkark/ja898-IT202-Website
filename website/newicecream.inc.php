...
<form name="newicecream" action="index.php" method="post">
   <table cellpadding="1" border="0">
       ...
       <tr>
           <td>Description:</td>
           <td><textarea name="icecreamDescription" size="20" minlength="25" maxlength="500" required></textarea></td>

       </tr>
       <tr>
           <td>Flavor:</td>
           <td><input type="text" name="icecreamFlavor" size="20" minlength="5" maxlength="100" required></td>
       </tr>
       <tr>
           <td>Serving Size:</td>
           <td><input type="text" name="icecreamServingSize" size="5" minlength="3" maxlength="10" required></td>
       </tr>
       <tr>
       ...
       <tr>
           ...
           <td><input type="number" step="0.01" name="icecreamWholesalePrice" size="5" min="0" max="999" required></td>
       </tr>
       <tr>
           <td>List Price:</td>
           <td><input type="number" step="0.01" name="icecreamListPrice" size="5" min="0" max="999" required></td>
       </tr>
   </table><br>
